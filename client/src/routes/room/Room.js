  ...
  const handleSaveCode = async () => {
    try {
      await fetch("/save", {
        ...
        body: JSON.stringify({ code: fetchedCode }),
      });
  ...
  return (
    <div className="room">
      ...
      <div className="roomActions">
        <button className="roomActionBtn" onClick={handleClearEditor}>
          Clear Editor
        </button>
        <button className="roomActionBtn" onClick={handleDownloadCode}>
          Download Code
        </button>
        <button className="roomActionBtn" onClick={handleSaveCode}>
          Save Code
        </button>
        <button className="roomActionBtn" onClick={handleLoadCode}>
          Load Code
        </button>
      </div>
